...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/github_com_Lockok_golang-niltodo_internal_core_transport_http_response.ErrorResponse"
                        }
                    },
                    "500": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_features_tasks_transport_http.PatchTaskRequestSwagger"
                        }
                    }
                ],
                "responses": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_features_users_transport_http.PatchUserRequestSwagger"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "github_com_Lockok_golang-niltodo_internal_core_transport_http_response.ErrorResponse": {
            "type": "object",
            "properties": {
                "error": {
                    "type": "string"
        ...
        "internal_features_tasks_transport_http.PatchTaskRequestSwagger": {
            "type": "object",
            "properties": {
                "completed": {
                    "type": "boolean",
        ...
        "internal_features_users_transport_http.PatchUserRequestSwagger": {
            "type": "object",
            "properties": {
                "full_name": {
                    "type": "string",
